...
<div class="slider-dots">
    <div class="slider-dots__items-wrapper">
        <img src="img/projects/project_8/carrots.jpg" alt="apple" class="slider-dots__item">
        <img src="img/projects/project_8/carrots-1.jpg" alt="apple" class="slider-dots__item">
        <img src="img/projects/project_8/carrots-2.jpg" alt="apple" class="slider-dots__item">
    </div>
...
<div class="slider-orange">
    ...
    <div class="orange__nav">
        <a href="{{ route('organic-about') }}" class="orange__arrow opacity">
