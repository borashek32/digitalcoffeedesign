...
<section class="reviews">
    <div class="reviews__review">
        ...
        <div class="review-content current">
            <div class="review">
                <div class="review__content">
                    <div class="block__text">1 Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularis.</div>
                    <div class="review__footer">
                        <div class="review__author">1 Ahmed Hridoy</div>
        ...
        <div class="review-content">
            <div class="review">
                <div class="review__content">
                    <div class="block__text">2 Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularis.</div>
                    <div class="review__footer">
                        <div class="review__author">2 Ahmed Hridoy</div>
                        <div class="review__actions actions">
                            <div class="actions__star-rating">
                                <img src="{{ asset('img/projects/project_8/star.png') }}" alt="star" class="actions__star">
                                <img src="{{ asset('img/projects/project_8/star.png') }}" alt="star" class="actions__star">
        ...
        <div class="review-content">
            <div class="review">
                <div class="review__content">
                    <div class="block__text">3 Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularis.</div>
                    <div class="review__footer">
                        <div class="review__author">3 Ahmed Hridoy</div>
                        <div class="review__actions actions">
                            <div class="actions__star-rating">
                                <img src="{{ asset('img/projects/project_8/star.png') }}" alt="star" class="actions__star">
                                <img src="{{ asset('img/projects/project_8/star.png') }}" alt="star" class="actions__star">
        ...
        <div class="review__buttons-slider buttons-slider">
            <div class="buttons-slider__wrapper prev">
                <div class=""><</div>
            </div>
            <div class="buttons-slider__wrapper next">
                <div class="">></div>
            </div>
        </div>
    </div>
