                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700
                               leading-tight focus:outline-none focus:shadow-outline @error('name') border-red-500 @enderror"
                               id="exampleFormControlInput2" placeholder="Введите название" wire:model="name">
