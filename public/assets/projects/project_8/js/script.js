...
function showSlideArrows(n) {
  ...
  slidesArrows.forEach(function (item) {
    return item.style.display = 'none';
  });
  slidesArrows[slideIndex].style.display = 'block';
}

showSlideArrows(0); // menu burger
...
function showSlideDots(e) {
  var slideTo = e.target.dataset.slideTo;
  slidesDots.forEach(function (item) {
    return item.style.display = 'none';
  });
